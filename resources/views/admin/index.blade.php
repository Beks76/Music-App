        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column">
                    ...
                    <a class="btn btn-info btn-just-icon btn-sm mt-4" href="{{ route('song.index') }}">Songs</a>
                    <a class="btn btn-info btn-just-icon btn-sm mt-4 mb-4" href="{{ route('user.index') }}">Users</a>
                </div>
            </div>
        </div>
    </div>
