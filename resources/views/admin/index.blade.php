        ...
        <div class="row">
            <div class="col-lg-12 col-md-10 mt-4 ml-auto mr-auto">
                ...
                <div class="col-md-6 offset-5 mt-5">
                    <a class="btn btn-info btn-just-icon btn-sm" href="{{ route('backend.create') }}">Add album</a>
                </div>
                        ...
                        @foreach($albums as $a)
                            <tr>
                                ...
                                <td class="d-sm-flex justify-content-right">
                                    ...
                                    <a href="{{route('backend.edit', $a->id)}}" rel="tooltip" class="btn btn-success btn-just-icon btn-sm" data-original-title="" title="">
                                        <i class="material-icons">edit</i>
                                    </a>
                                    <form action="{{route('backend.destroy', $a->id)}}" method="POST">
                                        @method('DELETE')
                                        @csrf
